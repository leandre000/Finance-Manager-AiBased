...
const Sidebar = ({ open, setOpen }: SidebarProps) => {
  return (
    <>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-64 lg:flex-col">
        <div className="flex grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6 pb-4">
          ...
          <div className="flex h-16 shrink-0 items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold gradient-text">Finance Manager</h1>
          ...
          <nav className="flex flex-1 flex-col">
            <ul role="list" className="flex flex-1 flex-col gap-y-7">
              ...
              <li className="mt-auto">
                <div className="flex items-center gap-x-4 px-3 py-3 text-sm font-semibold leading-6 text-gray-900 hover:bg-gray-50 rounded-lg transition-colors">
      ...
      <div
        className={cn(
          'fixed inset-y-0 z-40 flex w-64 flex-col bg-white transition-transform duration-300 ease-in-out lg:hidden',
